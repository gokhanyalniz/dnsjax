...
geometries/
  ...
  cartesian.py       # Fourier class, norms with Simpson y-integration, CartesianFlow base dataclass, on-device IMM operator assembly and LU factorisation (dense backend via DenseJAXSolver; banded backend via SPIKE block-partitioned per-block dense LU), Kleiser-Schumann IMM iteration, build_cartesian_stepper factory
flows/
